...
export const FINANCE_CATEGORIES: FinanceCategory[] = [
  ...
  // ─────────────────────── COMPLETE BUSINESS SERVICES ───────────────────────
  {
    ...
    stats: [
      { value: "6", label: "Registration services" },
    ...
    subs: [
      ...
      },
      {
        ...
        desc: "Monthly and quarterly GST returns prepared, reconciled and filed on time, with input credit matched against GSTR-2B before submission.",
        icon: "sync",
        image: U("photo-1450101499163-c8848c66ca85", 800),
        points: ["GSTR-1 and 3B filing", "2B input credit matching", "Annual return and reconciliation"],
        priceFrom: "Rs. 350/- per month",
        ctaLabel: "File GST online",
        intro:
          "GST is unforgiving about dates: late fees accrue per day, and a mismatch between what your suppliers filed and what you claimed becomes a notice months later. We prepare returns from your sales and purchase data, reconcile input credit against GSTR-2B before filing rather than after, and file ahead of the due date so interest never starts running.",
        includes: [
          { t: "GSTR-1 outward supplies", d: "Invoice-level reporting of sales, exports, credit notes and amendments, filed monthly or quarterly under QRMP as suits your turnover." },
          { t: "GSTR-3B summary return", d: "Tax liability computed, input credit claimed and payment challan prepared, with the return filed on time." },
          { t: "GSTR-2B reconciliation", d: "Your purchase register matched against what suppliers actually filed, so you claim only credit that will survive scrutiny — and chase suppliers who have not filed." },
          { t: "QRMP and PMT-06", d: "Quarterly filers handled properly, including the monthly tax payments that still fall due in between." },
          { t: "Annual return GSTR-9 and 9C", d: "Annual reconciliation prepared where turnover requires it, tying returns back to your books." },
          { t: "Notice and mismatch support", d: "If a discrepancy notice arrives, we reconstruct the position and draft the reply." },
        ],
        documents: [
          ...
          "GST portal credentials",
          "Previous period returns, for a first handover",
        ],
        who: ["Registered businesses of every size", "Traders and manufacturers", "Service providers and consultants", "E-commerce sellers", "Businesses behind on filings"],
        timeline: "Returns are prepared within 2–3 working days of receiving data and filed ahead of the statutory due date.",
        deliverables: [
          "Filed GSTR-1 and GSTR-3B with acknowledgements",
          "GSTR-2B reconciliation statement",
          "Tax payment challans",
          "Annual return, where applicable",
          "A running record of what was filed each period",
        ],
        mistakes: [
          { t: "Claiming credit without matching 2B", d: "Credit not reflected in GSTR-2B is routinely disallowed, with interest. Matching before filing avoids reversing it later." },
          { t: "Treating nil periods as nothing to do", d: "A nil return is still a return. Late fees accrue on nil filings exactly the same way." },
          { t: "Ignoring supplier non-compliance", d: "Your credit depends on your suppliers filing. Nobody tells you when they have not, so it has to be checked." },
          { t: "Missing QRMP monthly payments", d: "Quarterly filing does not mean quarterly payment. PMT-06 still falls due monthly and attracts interest if missed." },
        ],
        dueDates: [
          { label: "GSTR-1 (monthly)", when: "11th of the following month" },
          { label: "GSTR-3B (monthly)", when: "20th of the following month" },
          { label: "PMT-06 (QRMP taxpayers)", when: "25th of the following month" },
          { label: "GSTR-9 annual return", when: "31 December following the financial year" },
        ],
        faqs: [
          { q: "Which returns will I need to file?", a: "Most businesses file GSTR-1 and GSTR-3B, monthly or quarterly under QRMP depending on turnover. Composition dealers file CMP-08 and GSTR-4 instead. We confirm your set at the start." },
          { q: "What happens if I file late?", a: "Late fees accrue per day per return, plus interest on unpaid tax. Filing ahead of the due date is the only way to avoid it, which is why we work to an internal deadline earlier than the statutory one." },
          { q: "Why does GSTR-2B reconciliation matter?", a: "You can only reliably claim input credit that your suppliers have actually reported. Credit that is not in your 2B is routinely disallowed later with interest, so we match before filing rather than after." },
          { q: "Can you take over filings that are behind?", a: "Yes. We assess the backlog, quantify the late fees and interest, then file the pending periods in order and bring you onto a normal cycle." },
          { q: "Is the monthly fee fixed?", a: "The starting fee covers a straightforward return set at low invoice volume. High volumes, multiple GSTINs or e-invoicing are quoted separately, in writing, before we begin." },
        ],
        reasons: [
          "Returns filed ahead of the due date, every period",
          "Input credit matched to 2B before you claim it",
          "No per-day late fees quietly accumulating",
          "Mismatch notices handled rather than forwarded",
          "One predictable monthly fee",
          "A clean filing history if you ever seek finance",
        ],
      },
      {
        slug: "accounting-bookkeeping",
        label: "Accounting & Bookkeeping",
        desc: "Day-to-day books kept current and reconciled, with monthly management numbers you can actually act on rather than a year-end scramble.",
        icon: "finance",
        image: U("photo-1454165804606-c3d57bc86b40", 800),
        points: ["Monthly bookkeeping", "Bank and party reconciliation", "P&L and balance sheet"],
        priceFrom: "Rs. 999/- per month",
        ctaLabel: "Hire us",
        intro:
          "Accounting is not only about recording transactions — it is about knowing where your money is while you can still do something about it. We keep the ledgers current each month, reconcile bank and party balances so the numbers are trustworthy, and send a short management pack. Come year end, nothing needs reconstructing and the audit is straightforward.",
        includes: [
          { t: "Transaction recording", d: "Sales, purchases, expenses, payroll and journals entered in your software on a regular cycle rather than in an annual rush." },
          { t: "Bank reconciliation", d: "Every account reconciled monthly, so unrecorded charges, bounced payments and duplicate entries surface immediately." },
          { t: "Debtor and creditor ledgers", d: "Party-wise balances maintained and confirmed, giving you a real ageing view of who owes you what." },
          { t: "Monthly close and management pack", d: "Profit and loss, balance sheet and cash position, with a short note on what changed and why." },
          { t: "Statutory data preparation", d: "Books kept in a state that feeds GST returns, TDS filings and the income tax return without rework." },
          { t: "Software setup or migration", d: "Chart of accounts designed for your business in Tally, Zoho Books or ERPNext — or a clean migration from whatever you use now." },
        ],
        documents: [
          "Bank statements for the period",
          "Sales and purchase invoices",
          "Expense bills and vouchers",
          "Payroll register, if you employ staff",
          "Loan and asset schedules",
          "Access to your existing accounting file",
        ],
        who: ["Businesses without an in-house accountant", "Founders doing their own books", "Firms preparing for audit or due diligence", "Businesses whose books are behind", "Anyone wanting monthly numbers rather than annual ones"],
        timeline: "Monthly books are closed within 7–10 working days of receiving complete documents. A clean-up of historic books is scoped separately.",
        deliverables: [
          "Updated ledgers in your accounting software",
          "Monthly bank reconciliation statements",
          "Profit and loss and balance sheet",
          "Debtor and creditor ageing reports",
          "Year-end schedules ready for audit",
        ],
        mistakes: [
          { t: "Leaving everything to year end", d: "Reconstructing twelve months of entries is slower, dearer and far less accurate than closing each month." },
          { t: "Never reconciling the bank", d: "Unreconciled books hide bounced payments, duplicate entries and silent bank charges for months." },
          { t: "Booking capital purchases as expenses", d: "It distorts profit and depreciation, and is one of the first things an assessing officer checks." },
          { t: "Ignoring party balance confirmations", d: "Without confirmation, receivables on paper may not be collectable in practice." },
        ],
        faqs: [
          { q: "Can you take over books that are already behind?", a: "Yes. We start with a clean-up — reconstructing entries, reconciling bank and party balances, and bringing ledgers current — then move you onto a monthly cycle. The clean-up is scoped and quoted separately from the monthly fee." },
          { q: "Which accounting software do you work with?", a: "Tally, Zoho Books and ERPNext, plus most common packages. If you have no system yet we will recommend one that suits your size and volume rather than overselling you." },
          { q: "What is included in the monthly fee?", a: "Transaction recording, bank reconciliation, party ledgers and a monthly close with profit and loss and balance sheet. High transaction volumes, payroll and inventory are quoted on top, in writing." },
          { q: "Do I still need my own accountant?", a: "Many clients use us instead of an in-house hire. Others keep a junior accountant for day-to-day entry while we review and close each month. Both arrangements work." },
          { q: "How do I get documents to you each month?", a: "Whatever suits you — WhatsApp, email or a shared drive folder. We set up a simple routine at the start so nothing is missed." },
        ],
        reasons: [
          "Books stay current instead of being reconstructed",
          "Monthly numbers you can act on in time",
          "Audit-ready records with a clear document trail",
          "Errors caught in the month they happen",
          "Works with Tally, Zoho Books or ERPNext",
          "Cheaper and steadier than a full-time hire",
        ],
      },
    ],
    documents: [
