  ...
  return (
    <section className="section overflow-hidden bg-charcoal-50/50">
      <div className="container-x">
        ...
        <Reveal delay={0.1} className="relative mx-auto mt-10 aspect-square w-full max-w-md">
        ...
        <Reveal delay={0.15} className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link href="/services" className="btn-primary btn-glow">Explore Our Services →</Link>
