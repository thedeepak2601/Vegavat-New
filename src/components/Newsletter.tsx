...
export default function Newsletter() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-3xl border border-violet/10 bg-gradient-to-br from-violet-50 via-[#F6F1FF] to-[#EDF8FC] px-7 dark:from-[#171426] dark:via-[#141122] dark:to-[#101a24] py-10 shadow-card sm:px-12 sm:py-12"
    >
      ...
      <div className="relative grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div className="text-center lg:text-left">
          ...
          <h3 className="mt-4 text-3xl font-extrabold leading-[1.15] tracking-tight text-charcoal sm:text-4xl">
          ...
          <form onSubmit={onSubmit} className="mx-auto mt-7 max-w-md space-y-3 lg:mx-0">
            ...
            <label className="relative block">
              ...
              <svg className="pointer-events-none absolute left-5 top-1/2 h-5 w-5 -translate-y-1/2 text-charcoal/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <input
                ...
                className="w-full rounded-full border border-white bg-white py-4 pl-14 pr-5 text-sm font-medium text-charcoal shadow-sm outline-none transition-all placeholder:text-charcoal/40 focus:border-violet/40 focus:shadow-card disabled:opacity-60"
              />
            </label>
          ...
          <ul className="mt-2 flex flex-wrap justify-center gap-x-5 gap-y-2 lg:justify-start">
            {PERKS.map((f) => (
              <li
                key={f}
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-charcoal/60"
              >
