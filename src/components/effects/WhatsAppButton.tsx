...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 left-6 z-[90] inline-flex h-12 w-12 items-center justify-center gap-2 overflow-hidden rounded-full border border-white/15 bg-gradient-to-br from-[#25D366] to-[#12B95B] text-white shadow-[0_14px_34px_-12px_rgba(37,211,102,0.85)] transition-all duration-300 hover:w-40 hover:justify-start hover:px-3 hover:shadow-glow"
    >
